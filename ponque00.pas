program ponque(input,output);
 ...
 var
	...
	HPsraim,HPSraim0,AHP,BHP,CHP,HP0,AMP,BMP,CMP,MP0:integer;
...
begin
 ...
 FirstSetting0(AHP,BHP,CHP,HP0,HPSraim,HPSraim0,AMP,BMP,CMP,MP0,AHPPlusHoimi,BHPPlusHoimi,CHPPlusHoimi,
						 	 ...
						 	 AMagicPlus,BMagicPlus,CMagicPlus,ToughPlus,Yakusou,Amol,Seisui,Eluf,AYakusou,BYakusou,CYakusou,AAmol,BAmol,CAmol,ASeisui,BSeisui,CSeisui,AEluf,BEluf,CEluf,AstronCount,
